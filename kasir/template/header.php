...
<body>
    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full"
        ...
        <header class="topbar" data-navbarbg="skin5">
            <nav class="navbar top-navbar navbar-expand-md navbar-dark m-b-0" style="position:fixed; width: 100%; margin-top: -5px; height: 70px;">
                <div class="navbar-header" data-logobg="skin5" style="height: 64px;">
                    ...
                    <a class="navbar-brand" href="index.html">
                        ...
                        <b class="logo-icon ps-2">
                            ...
                            <p class="text-center tulisan" style="margin-top: -7px;"><?php echo $toko['nama_toko'];?></p>
