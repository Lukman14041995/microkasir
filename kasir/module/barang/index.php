...
<div class="card">
	...
	<div class="row">
                  <div class="col-lg-12 main-chart">
					  <a href="index.php?page=jual" class="btn btn-danger text-white"><i class="mdi mdi-keyboard-backspace"></i> Kembali</a>
						<h3 class="mt-3">Data Stok Barang</h3>
						<br/>
								...
								?>
									<tr>
										...
										<td> 
											...
											<a href="fungsi/hapus/hapus.php?barang=hapus&id=<?php echo $isi['id'];?>" onclick="javascript:return confirm('Hapus Data barang ?');"><button class="btn btn-danger btn-xs"  style="color: white;" title="Hapus"><i style="color: white;" class="mdi mdi-delete"></i></button></a>
											<?php }?>
										</td>
									</tr>
								<?php 
