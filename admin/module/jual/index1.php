						...
						<div class="panel-body">
							...
							<div id="kasirnya">
								<table class="table table-stripped">
										...
										if(!empty($bayar))
										{
											...
											if($bayar )
											{
												...
												for($x=0;$x<$jumlah_dipilih;$x++){
													...
													$d = array($id_barang[$x],$id_member[$x],$invoice[$x],$jumlah[$x],$total[$x],$tgl_input[$x],$periode[$x],$disc[$x],$pay[$x],$kembali[$x]);
													$sql = "INSERT INTO nota (id_barang,id_member,invoice,jumlah,total,tanggal_input,periode,discount,bayar,kembali) VALUES(?,?,?,?,?,?,?,?,?,?)";
									...
									<!-- <form action="print.php" target="_blank" method="get"> -->
										<?php foreach($hasil_penjualan as $isi){;?>
										...
										<tr>
											...
											<td><input type="text" onkeyup="sum();" class="form-control" id="txtbayar" name="pay[]"></td>
									...
									<tr>
										<td>Kembali</td>
										<td><input type="text" class="form-control" name="kembali[]" onkeyup="sum();" id="txtkembali"></td>
