          ...
          <section class="wrapper"> -->
              <div class="card">
                  ...
                  <div class="col-lg-12 main-chart">
						...
						<?php $id = $_SESSION['superuser']['id_cabang']; ?>
							...
							<thead>
								...
								<tfoot>
									<tr>
										...
										<th colspan="2" style="background:#ddd"></td>
										<td></td>
										<th>Pengeluaran</th>
										<th colspan="2" style="text-align: center;">Rp.<?php echo number_format($pengeluaran['nominal'] )?></th>
							...
							<form action="" method="post">
								...
								<tfoot>
									<tr>
										...
										<th>Rp.<?php echo number_format($totalsemua) ;?>,-</td>
										<th colspan="3" style="background:#ddd"></>
										<td></td>
										<th>Pengeluaran</th>
